...
const THEMES = [
    { hue: 20, tagColor: "var(--tag-20-color)", tagBg: "var(--tag-20-bg)", vineStroke: "oklch(60% 0.05 20)", leafA: "oklch(78% 0.05 20)", leafB: "oklch(83% 0.06 300)" },
    { hue: 300, tagColor: "var(--tag-300-color)", tagBg: "var(--tag-300-bg)", vineStroke: "oklch(60% 0.06 300)", leafA: "oklch(83% 0.06 300)", leafB: "oklch(78% 0.05 20)" },
    { hue: 85, tagColor: "var(--tag-85-color)", tagBg: "var(--tag-85-bg)", vineStroke: "oklch(60% 0.06 85)", leafA: "oklch(83% 0.05 85)", leafB: "oklch(78% 0.05 20)" },
];
...
export default function WorkLogPage() {
    ...
    return (
        <div style={{ background: "var(--background)", color: "var(--foreground)", fontFamily: "var(--font-outfit), sans-serif", minHeight: "100vh", overflowX: "hidden", position: "relative" }}>
            ...
            <Reveal style={{ maxWidth: 1020, margin: "0 auto", padding: "60px var(--page-pad) 30px", textAlign: "center" }}>
                <div style={{ fontFamily: "var(--font-cormorant), serif", fontStyle: "italic", fontSize: 17, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--ink-60-300)", marginBottom: 18 }}>Marginalia</div>
                <h1 style={{ fontFamily: "var(--font-cormorant), serif", fontWeight: 500, fontSize: 64, margin: "0 0 20px" }}>Work Log</h1>
                <p style={{ fontSize: 17, lineHeight: 1.7, color: "var(--ink-40-40)", fontWeight: 300, margin: 0 }}>
            ...
            <section style={{ maxWidth: 960, margin: "0 auto", padding: "0 var(--page-pad) 130px", display: "flex", flexDirection: "column", gap: 48 }}>
                {entries.map((entry, index) => {
                    ...
                    return (
                        <div key={entry.slug} style={{ display: "flex", alignItems: "flex-start", gap: 22 }}>
                            ...
                            >
                                <svg data-sprig width="100%" height="100%" viewBox="0 0 64 220" style={{ display: "block" }} fill="none">
                            ...
                            <Reveal style={{ flex: "1 1 auto", minWidth: 0, paddingTop: 6 }}>
                                <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap", marginBottom: 10 }}>
                                    <div style={{ fontFamily: "var(--font-outfit), sans-serif", fontSize: 12.5, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--ink-50-40)" }}>{entry.date}</div>
                                ...
                                <p style={{ fontSize: 15.5, lineHeight: 1.75, color: "var(--ink-35-40)", fontWeight: 300, margin: 0, whiteSpace: "pre-wrap" }}>{entry.body}</p>
                            </Reveal>
                        </div>
                    );
                })}
